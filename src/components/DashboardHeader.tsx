                  ...
                  <div>
                    ...
                    {eventResults.map((event) => (
                        <div key={event._id} className="flex items-center justify-between p-2 hover:bg-muted rounded-xl transition-colors">
                          ...
                          <Button size="sm" variant="outline" onClick={() => rsvpToEvent(event._id)} className="h-7 text-[10px] font-bold">RSVP</Button>
                        </div>
                    ))}
                  </div>
                </div>
              ...
              <PopoverContent className="w-64 p-3 rounded-2xl shadow-2xl border-border/60" align="end">
                <div className="flex items-center gap-3 px-1 py-2 mb-2">
                  ...
                  <div className="flex flex-col min-w-0">
                    <p className="text-sm font-bold text-foreground truncate leading-none mb-1.5">{user?.firstName} {user?.lastName}</p>
                    <span className={cn("text-[9px] px-2 py-0.5 rounded-md font-bold uppercase tracking-wider border shadow-sm w-fit", getRoleColor(user?.level || 1))}>
                ...
                <div className="space-y-1 pt-1">
                  ...
                  <Button variant="ghost" className="w-full justify-start h-10 text-sm gap-3 text-destructive hover:bg-destructive/10 rounded-xl px-2.5" onClick={handleLogout}>
