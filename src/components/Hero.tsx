      ...
      <div className="container mx-auto px-4 relative z-10 text-center">
        <div className="max-w-4xl mx-auto space-y-8">
          ...
          <p className="text-lg md:text-xl text-white/90 max-w-2xl mx-auto mb-12">
            Bringing Ivorians in Texas together as one big family. Stay connected, support each other, 
            and celebrate our beautiful culture while building a strong community.
          </p>
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
            <Button 
              size="lg" 
              className="bg-white text-primary hover:bg-white/90 shadow-elegant font-semibold px-8 py-6 text-lg"
            >
              Become a Member
